...
var uCFirst = function uCFirst(str) {
    return ''
        .concat(str.substr(0, 1).toUpperCase())
        .concat(str.substr(1, str.length - 1));
};
...
var lCFirst = function lCFirst(str) {
    return ''
        .concat(str.substr(0, 1).toLowerCase())
        .concat(str.substr(1, str.length - 1));
};
...
var convertToCamel = function convertToCamel(str) {
    ...
    return ''
        .concat(strLowerCased.substr(0, 1).toUpperCase())
        .concat(strLowerCased.substr(1, strLowerCased.length - 1));
};
