                    ...
                    _extends({}, props, {
                        openModal: function openModal() {
                            ...
                            return (_reference$current =
                                reference.current).openExternal.apply(
                                _reference$current,
                                arguments,
                            );
                        },
                        openConfirmModal: function openConfirmModal() {
                            ...
                            return (_reference$current2 =
                                reference.current).openConfirm.apply(
                                _reference$current2,
                                arguments,
                            );
                        },
                        closeModal: function closeModal() {
                            ...
                            return (_reference$current3 =
                                reference.current).closeExternal.apply(
                                _reference$current3,
                                arguments,
                            );
                        },
