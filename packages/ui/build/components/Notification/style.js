...
var disappear = (0, _styledComponents.keyframes)([
    'from{opacity:1;transform:translate(0,0);}to{opacity:0;height:0;transform:translate(0,-20px);}',
]);
...
var Message = _styledComponents.default.div.withConfig({
    ...
    [
        'margin-right:0.5rem;background-color:white;animation:',
        ' 0.25s ease;',
        ' border:1px solid ',
        ';border-radius:2px;position:relative;box-shadow:4px 6px 15px -4px rgba(0,0,0,0.21);overflow-x:hidden;padding:0.5rem 2.5rem 0.5rem 0;width:20rem;',
    ],
    appear,
    function(props) {
...
var MessageWrap = _styledComponents.default.div.withConfig({
    ...
    return props.closing
        ? (0, _styledComponents.css)(
              [
                  'animation:',
                  ' 0.5s ease;animation-fill-mode:forwards;overflow:hidden;',
              ],
              disappear,
          )
        : '';
...
var Text = _styledComponents.default.div.withConfig({
    ...
    return (0,
    _scCompanion.iconLabel)(getMessageIcon(props), '1.3rem', '0', 'baseline', '2.5rem');
});
...
var Close = _styledComponents.default.div.withConfig({
    ...
    (0, _scCompanion.icon)('close', '1rem', '0.7rem'),
);
